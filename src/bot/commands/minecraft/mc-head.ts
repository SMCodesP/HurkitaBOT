...
class McHeadCommand extends Command {
    ...
    const embed = new MessageEmbed()
      ...
      .setColor("RANDOM")
      .setDescription(`Clique [aqui](https://crafatar.com/renders/head/${uuid}?size=256&default=c06f89064c8a49119c29ea1dbd1aab82&overlay) para baixar a head`)
      .setImage(`https://crafatar.com/renders/head/${uuid}?size=256&default=c06f89064c8a49119c29ea1dbd1aab82&overlay`)
      .setTimestamp()
