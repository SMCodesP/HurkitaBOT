...
class McSkinCommand extends Command {
  ...
  async exec(message: Message, { nickname }: { nickname?: string }) {
    ...
    const embed = new MessageEmbed()
      ...
      .setColor('RANDOM')
      .setDescription(
        `Clique [aqui](https://crafatar.com/skins/${uuid}?size=4&default=c06f89064c8a49119c29ea1dbd1aab82&overlay) para baixar a skin`
      )
      .setImage(
        `https://crafatar.com/skins/${uuid}?size=256&default=c06f89064c8a49119c29ea1dbd1aab82&overlay`
      )
      .setTimestamp()
      .setFooter(
        nickname,
