...
class McBodyCommand extends Command {
	...
	async exec(message: Message, { nickname }: { nickname?: string }) {
		...
		const embed = new MessageEmbed()
			...
			.setColor("RANDOM")
			.setDescription(`Clique [aqui](https://crafatar.com/renders/body/${uuid}?size=256&default=c06f89064c8a49119c29ea1dbd1aab82&overlay) para baixar a body`)
			.setImage(`https://crafatar.com/renders/body/${uuid}?size=256&default=c06f89064c8a49119c29ea1dbd1aab82&overlay`)
			.setTimestamp()
